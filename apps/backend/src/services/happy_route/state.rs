...
pub struct HappyRouteState {
    ...
    pub(super) auth_session_token_by_account_id: HashMap<String, String>,
    ...
    pub(super) provider_attempts_by_id: HashMap<String, ProviderAttemptRecord>,
    pub(super) provider_attempt_id_by_request_key: HashMap<String, String>,
    pub(super) provider_attempt_id_by_provider_ref: HashMap<String, String>,
    pub(super) raw_provider_callbacks_by_id: HashMap<String, RawProviderCallbackRecord>,
    pub(super) raw_provider_callback_id_by_dedupe_key: HashMap<String, String>,
    pub(super) normalized_observation_dedupe_keys: HashSet<String>,
